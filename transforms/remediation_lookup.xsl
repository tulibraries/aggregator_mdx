...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="geonamesLocation">
      <padig:location string="Abbott Brook (Oxford county, Maine : stream)" uri="http://sws.geonames.org/4956405/">Abbott Brook (Oxford county, Maine : stream)</padig:location>
      <padig:location string="Adams (Berkshire county, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4928733/">Adams (Berkshire county, Massachusetts : inhabited place)</padig:location>
      <padig:location string="Adams, Mount (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5082535/">Adams, Mount (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Akers Pond (Coos county, New Hampshire : lake)" uri="http://sws.geonames.org/5082551/">Akers Pond (Coos county, New Hampshire : lake)</padig:location>
      <padig:location string="Amherst (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5082636/">Amherst (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Androscoggin River (United States, North and Central America : river)" uri="http://sws.geonames.org/4956765/">Androscoggin River (United States, North and Central America : river)</padig:location>
      <padig:location string="Ashland (Aroostook county, Maine : inhabited place)" uri="http://sws.geonames.org/4956929/">Ashland (Aroostook county, Maine : inhabited place)</padig:location>
      <padig:location string="Aziscohos Lake (Oxford County, Maine : Reservoir)" uri="http://sws.geonames.org/4957046/">Aziscohos Lake (Oxford County, Maine : reservoir)</padig:location>
      <padig:location string="Bald Cap (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5082921/">Bald Cap (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Beaver Pond (Franklin county, Maine : lake)" uri="http://sws.geonames.org/4957867/">Beaver Pond (Franklin county, Maine : lake)</padig:location>
      <padig:location string="Belgrade Lakes (Kennebec county, Maine : inhabited place)" uri="http://sws.geonames.org/4957964/">Belgrade Lakes (Kennebec county, Maine : inhabited place)</padig:location>
      <padig:location string="Berlin (Coos County, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5083330/">Berlin (Coos County, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Alexandria (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5082573/">Alexandria (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Bethlehem (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5083374/">Bethlehem (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Black Mountain (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5083493/">Black Mountain (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Bosebuck Mountain (Oxford county, Maine : peak)" uri="http://sws.geonames.org/4958978/">Bosebuck Mountain (Oxford county, Maine : peak)</padig:location>
      <padig:location string="Boston (Suffolk county, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4930956/">Boston (Suffolk county, Massachusetts : inhabited place)</padig:location>
      <padig:location string="Bowman (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5083703/">Bowman (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Byron (Oxford county, Maine : inhabited place)" uri="http://sws.geonames.org/4959809/">Byron (Oxford county, Maine : inhabited place)</padig:location>
      <padig:location string="Cambridge (Middlesex county, Massachusetts : inhabited place" uri="http://sws.geonames.org/4931972/">Cambridge (Middlesex county, Massachusetts : inhabited place</padig:location>
      <padig:location string="Camp Wellfleet Dunes (Barnstable county, Massachusetts : dunes)" uri="http://sws.geonames.org/4932158/">Camp Wellfleet Dunes (Barnstable county, Massachusetts : dunes)</padig:location>
      <padig:location string="Campbell River (Vancouver Island, British Columbia : inhabited place)" uri="http://sws.geonames.org/5914132/">Campbell River (Vancouver Island, British Columbia : inhabited place)</padig:location>
      <padig:location string="Cape Elizabeth (Cumberland county, Maine : inhabited place)" uri="http://sws.geonames.org/4960078/">Cape Elizabeth (Cumberland county, Maine : inhabited place)</padig:location>
      <padig:location string="Cates Hill (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5084321/">Cates Hill (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Cedar Pond (Coos county, New Hampshire : lake)" uri="http://sws.geonames.org/5084348/">Cedar Pond (Coos county, New Hampshire : lake)</padig:location>
      <padig:location string="Chocorua, Mount (Carroll county, New Hampshire : peak)" uri="http://sws.geonames.org/5084573/">Chocorua, Mount (Carroll county, New Hampshire : peak)</padig:location>
      <padig:location string="Clinton (Oneida county, New York state : inhabited place)" uri="http://sws.geonames.org/5112972/">Clinton (Oneida county, New York state : inhabited place)</padig:location>
      <padig:location string="Concord (Merrimack county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5084868/">Concord (Merrimack county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Corvallis (Benton county, Oregon : inhabited place)" uri="http://sws.geonames.org/5720727/">Corvallis (Benton county, Oregon : inhabited place)</padig:location>
      <padig:location string="Cupsuptic Lake (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4961945/">Cupsuptic Lake (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Danbury (Merrimack county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5085222/">Danbury (Merrimack county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Danville (Caledonia county, Vermont : inhabited place)" uri="http://sws.geonames.org/5235353/">Danville (Caledonia county, Vermont : inhabited place)</padig:location>
      <padig:location string="Derry (Rockingham county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5085374/">Derry (Rockingham county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Diamond Ridge (Coos county, New Hampshire : ridge)" uri="http://sws.geonames.org/5085410/">Diamond Ridge (Coos county, New Hampshire : ridge)</padig:location>
      <padig:location string="Dry Mills (Cumberland county, Maine : inhabited place)" uri="http://sws.geonames.org/4962880/">Dry Mills (Cumberland county, Maine : inhabited place)</padig:location>
      <padig:location string="Dummer (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5085591/">Dummer (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Elkton (Cecil county, Maryland : inhabited place)" uri="http://sws.geonames.org/4354234/">Elkton (Cecil county, Maryland : inhabited place)</padig:location>
      <padig:location string="Errol (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5085927/">Errol (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Fitchburg (Worcester county, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4936812/">Fitchburg (Worcester county, Massachusetts : inhabited place)</padig:location>
      <padig:location string="Florida (United States, North and Central America : state)" uri="http://sws.geonames.org/4155751/">Florida (United States, North and Central America : state)</padig:location>
      <padig:location string="Forest, Mount (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5086270/">Forest, Mount (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Franklin (Merrimack county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5086344/">Franklin (Merrimack county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Gilead (Oxford county, Maine : inhabited place)" uri="http://sws.geonames.org/4965217/">Gilead (Oxford county, Maine : inhabited place)</padig:location>
      <padig:location string="Gorham (Coos County, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5086700/">Gorham (Coos County, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Gorham (Cumberland county, Maine : inhabited place)" uri="http://sws.geonames.org/4965481/">Gorham (Cumberland county, Maine : inhabited place)</padig:location>
      <padig:location string="Hampstead (Rockingham county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5087105/">Hampstead (Rockingham county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Holderness (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5087552/">Holderness (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Holyoke (Hampden County, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4939783/">Holyoke (Hampden County, Massachusetts : inhabited place)</padig:location>
      <padig:location string="Intervale (Carroll county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5087992/">Intervale (Carroll county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Jefferson (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5088090/">Jefferson (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Kennebago (Franklin county, Maine : inhabited place)" uri="http://sws.geonames.org/4968697/">Kennebago (Franklin county, Maine : inhabited place)</padig:location>
      <padig:location string="Kennebago Lake (Franklin county, Maine : Lake)" uri="http://sws.geonames.org/4968709/">Kennebago Lake (Franklin county, Maine : Lake)</padig:location>
      <padig:location string="Kennebago River (Franklin County, Maine : river)" uri="http://sws.geonames.org/4968702/">Kennebago River (Franklin County, Maine : river)</padig:location>
      <padig:location string="Kennebunk (York county, Maine : inhabited place)" uri="http://sws.geonames.org/4968729/">Kennebunk (York county, Maine : inhabited place)</padig:location>
      <padig:location string="Kingston (Washington county, Rhode Island : inhabited place)" uri="http://sws.geonames.org/5223006/">Kingston (Washington county, Rhode Island : inhabited place)</padig:location>
      <padig:location string="La Tuque (Quebec province, Canada : inhabited place)" uri="http://sws.geonames.org/6050416/">La Tuque (Quebec province, Canada : inhabited place)</padig:location>
      <padig:location string="Laconia (Belknap county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5088438/">Laconia (Belknap county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Lancaster (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5088529/">Lancaster (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Lewiston (Androscoggin county, Maine : inhabited place)" uri="http://sws.geonames.org/4969398/">Lewiston (Androscoggin county, Maine : inhabited place)</padig:location>
      <padig:location string="Lincoln Pond (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4969568/">Lincoln Pond (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Long Pond (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4970424/">Long Pond (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Lower Richardson Lake (Oxford county, Maine : reservoir)" uri="http://sws.geonames.org/4970762/">Lower Richardson Lake (Oxford county, Maine : reservoir)</padig:location>
      <padig:location string="Lyman (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5089107/">Lyman (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Lynchtown (Oxford county, Maine : inhabited place)" uri="http://sws.geonames.org/4970864/">Lynchtown (Oxford county, Maine : inhabited place)</padig:location>
      <padig:location string="Magalloway Mountain (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5089154/">Magalloway Mountain (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Magalloway River (United States, North and Central America : river)" uri="http://sws.geonames.org/5089155/">Magalloway River (United States, North and Central America : river)</padig:location>
      <padig:location string="Maidstone (Essex county, Vermont : inhabited place)" uri="http://sws.geonames.org/5238236/">Maidstone (Essex county, Vermont : inhabited place)</padig:location>
      <padig:location string="Manchester (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5089178/">Manchester (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="McCallum (Forrest county, Mississippi : inhabited place)" uri="http://sws.geonames.org/4435288/">McCallum (Forrest county, Mississippi : inhabited place)</padig:location>
      <padig:location string="Meredith (Belknap county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5089449/">Meredith (Belknap county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Metallak Brook (Oxford county, Maine : stream)" uri="http://sws.geonames.org/4971862/">Metallak Brook (Oxford county, Maine : stream)</padig:location>
      <padig:location string="Milan (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5089546/">Milan (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Milan Hill (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5089547/">Milan Hill (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Milford (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5089578/">Milford (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Mollidgewock Pond (Oxford county, Maine : lake)" uri="http://sws.geonames.org/5089578/">Mollidgewock Pond (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Nashua (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090046/">Nashua (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="New Ipswich (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090183/">New Ipswich (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Newport (Sullivan county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090256/">Newport (Sullivan county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Newell Brook (Coos county, New Hampshire : stream)" uri="http://sws.geonames.org/5090216/">Newell Brook (Coos county, New Hampshire : stream)</padig:location>
      <padig:location string="Newmarket (Merrimack county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090245/">Newmarket (Merrimack county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="North Hampton (Rockingham county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090383/">North Hampton (Rockingham county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="North Stratford (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5090429/">North Stratford (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Northfield (Washington county, Vermont : inhabited place)" uri="http://sws.geonames.org/5239281/">Northfield (Washington county, Vermont : inhabited place)</padig:location>
      <padig:location string="Norton (Essex county, Vermont : inhabited place)" uri="http://sws.geonames.org/5239306/">Norton (Essex county, Vermont : inhabited place)</padig:location>
      <padig:location string="Norton Pond (Essex county, Vermont : pond)" uri="http://sws.geonames.org/5239313/">Norton Pond (Essex county, Vermont : pond)</padig:location>
      <padig:location string="Norway (Oxford county, Maine : inhabited place)" uri="http://sws.geonames.org/4973840/">Norway (Oxford county, Maine : inhabited place)</padig:location>
      <padig:location string="Old Speck Mountain (Oxford county, Maine : mountain)" uri="http://sws.geonames.org/4974223/">Old Speck Mountain (Oxford county, Maine : mountain)</padig:location>
      <padig:location string="Oquossoc (Franklin county, Maine : inhabited place)" uri="http://sws.geonames.org/4974276/">Oquossoc (Franklin county, Maine : inhabited place)</padig:location>
      <padig:location string="Parmachenee Lake (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4974685/">Parmachenee Lake (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Pensacola (Escambia county, Florida : inhabited place)" uri="http://sws.geonames.org/4168228/">Pensacola (Escambia county, Florida : inhabited place)</padig:location>
      <padig:location string="Pittsburg (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5091247/">Pittsburg (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Plaistow (Rockingham county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5091273/">Plaistow (Rockingham county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Plymouth (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5091310/">Plymouth (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Poland Spring (Androscoggin county, Maine : inhabited place)" uri="http://sws.geonames.org/4975614/">Poland Spring (Androscoggin county, Maine : inhabited place)</padig:location>
      <padig:location string="Pontook Reservoir (Coos county, New Hampshire : reservoir)" uri="http://sws.geonames.org/5091363/">Pontook Reservoir (Coos county, New Hampshire : reservoir)</padig:location>
      <padig:location string="Portland (Cumberland County, Maine : inhabited place)" uri="http://sws.geonames.org/4975802/">Portland (Cumberland County, Maine : inhabited place)</padig:location>
      <padig:location string="Presque Isle (Aroostook county, Maine : inhabited place)" uri="http://sws.geonames.org/4975966/">Presque Isle (Aroostook county, Maine : inhabited place)</padig:location>
      <padig:location string="Randolph (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5091604/">Randolph (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Rump Mountain (Oxford county, Maine : mountain)" uri="http://sws.geonames.org/4977136/">Rump Mountain (Oxford county, Maine : mountain)</padig:location>
      <padig:location string="Salem (Rockingham county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5092268/">Salem (Rockingham county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Sanbornton (Belknap county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5092338/">Sanbornton (Belknap county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Sandwich (Carroll county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5092370/">Sandwich (Carroll county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Sanmaur (Quebec province, Canada : inhabited place)" uri="http://sws.geonames.org/6141018/">Sanmaur (Quebec province, Canada : inhabited place)</padig:location>
      <padig:location string="Saratoga Springs (Saratoga county, New York state : inhabited place)" uri="http://sws.geonames.org/5136334/">Saratoga Springs (Saratoga county, New York state : inhabited place)</padig:location>
      <padig:location string="Shelburne (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5092608/">Shelburne (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Stag Hollow Brook (Coos county, New Hampshire : stream)" uri="http://sws.geonames.org/5093074/">Stag Hollow Brook (Coos county, New Hampshire : stream)</padig:location>
      <padig:location string="Stearns Brook (Coos county, New Hampshire : stream)" uri="http://sws.geonames.org/5093123/">Stearns Brook (Coos county, New Hampshire : stream)</padig:location>
      <padig:location string="Strafford (Orange county, Vermont : inhabited place)" uri="http://sws.geonames.org/5241636/">Strafford (Orange county, Vermont : inhabited place)</padig:location>
      <padig:location string="Sturtevant Pond (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4980101/">Sturtevant Pond (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Success Hill (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5093292/">Success Hill (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Success Pond (Coos county, New Hampshire : lake)" uri="http://sws.geonames.org/5093293/">Success Pond (Coos county, New Hampshire : lake)</padig:location>
      <padig:location string="Success, Mount (Coos county, New Hampshire : peak)" uri="http://sws.geonames.org/5093295/">Success, Mount (Coos county, New Hampshire : peak)</padig:location>
      <padig:location string="Sugar Hill (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5093309/">Sugar Hill (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Swift Diamond River (Coos county, New Hampshire : river)" uri="http://sws.geonames.org/5093442/">Swift Diamond River (Coos county, New Hampshire : river)</padig:location>
      <padig:location string="Taunton (Bristol county, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4952629/">Taunton (Bristol county, Massachuesetts : inhabited place)</padig:location>
      <padig:location string="Taunton (Bristol county, Massachusetts : inhabited place)" uri="http://sws.geonames.org/4952629/">Taunton (Bristol county, Massachusetts : inhabited place)</padig:location>
      <padig:location string="Thirteen Mile Woods (Coos county, New Hampshire : woods)" uri="http://sws.geonames.org/5093599/">Thirteen Mile Woods (Coos county, New Hampshire : woods)</padig:location>
      <padig:location string="Thrasher Peaks (Oxford county, Maine : peak)" uri="http://sws.geonames.org/4980714/">Thrasher Peaks (Oxford county, Maine : peak)</padig:location>
      <padig:location string="Tinker Brook (Coos county, New Hampshire : stream)" uri="http://sws.geonames.org/5093689/">Tinker Brook (Coos county, New Hampshire : stream)</padig:location>
      <padig:location string="Tupper Lake (Franklin county, New York state : inhabited place)" uri="http://sws.geonames.org/5141569/">Tupper Lake (Franklin county, New York state : inhabited place)</padig:location>
      <padig:location string="Waterville Valley (Grafton county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5094304/">Waterville Valley (Grafton county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Washington, Mount (Coos county, New Hampshire : mountain)" uri="http://sws.geonames.org/5094284/">Washington, Mount (Coos county, New Hampshire : mountain)</padig:location>
      <padig:location string="West Palm Beach (Palm Beach county, Florida : inhabited place)" uri="http://sws.geonames.org/4177887/">West Palm Beach (Palm Beach county, Florida : inhabited place)</padig:location>
      <padig:location string="Westchester (New York state, United States : county)" uri="http://sws.geonames.org/5144050/">Westchester (New York state, United States : county)</padig:location>
      <padig:location string="Whitefield (Coos county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5094647/">Whitefield (Coos county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Wilsons Mills (Oxford County, Maine : inhabited place)" uri="http://sws.geonames.org/4983281/">Wilsons Mills (Oxford County, Maine : inhabited place)</padig:location>
      <padig:location string="Winnipesaukee, Lake (New Hampshire, United States : lake)" uri="http://sws.geonames.org/5094864/">Winnipesaukee, Lake (New Hampshire, United States : lake)</padig:location>
      <padig:location string="Wilton (Hillsborough county, New Hampshire : inhabited place)" uri="http://sws.geonames.org/5094802/">Wilton (Hillsborough county, New Hampshire : inhabited place)</padig:location>
      <padig:location string="Turner (Androscoggin county, Maine : inhabited place)" uri="http://sws.geonames.org/4981250/">Turner (Androscoggin county, Maine : inhabited place)</padig:location>
      <padig:location string="Umbagog Lake (United States, North and Central America : lake)" uri="http://sws.geonames.org/5093916/">Umbagog Lake (United States, North and Central America : lake)</padig:location>
      <padig:location string="Upper Richardson Lake (Oxford county, Maine : lake)" uri="http://sws.geonames.org/4981659/">Upper Richardson Lake (Oxford county, Maine : lake)</padig:location>
      <padig:location string="Victory (Essex county, Vermont : inhabited place)" uri="http://sws.geonames.org/5242301/">Victory (Essex county, Vermont : inhabited place)</padig:location>
    </xsl:param>
