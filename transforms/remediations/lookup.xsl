...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Library Company -->
        ...
        <padig:set string="Civil War Campaigns and Battes">Islandora_CVCB1</padig:set>
        ...
        <padig:set string="McAllister Civil War Scrapbooks">Islandora_CIVL1</padig:set>
        ...
        <padig:set string="Scrapbook of Trade Cards, Tickets, and Other Ephemera">Islandora_STCOE</padig:set>
        ...
        <padig:set string="Views of Louden &amp; Stenton Album">Islandora_LOUD1</padig:set>
