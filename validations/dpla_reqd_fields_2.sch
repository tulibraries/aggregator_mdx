...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern>
      <title>DPLA fields required</title>
    ...
    <pattern>
      ...
      <pattern>
          ...
          <rule context="oai_dc:dc/dc:relation">
              <assert test="normalize-space(.) != 'pdcp_noharvest'">The relation element must not contain stopword</assert>
          </rule>
      </pattern>
      <pattern>
          <title>Additional Metadata Requirements</title>
          <rule context="oai_dc:dc/dc:rights">
              <assert test="normalize-space(.) != 'pdcp_noharvest'">The rights element must not contain stopword</assert>
          </rule>
      </pattern>
</schema>
